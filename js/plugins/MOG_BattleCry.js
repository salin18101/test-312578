...
　　var Moghunter = Moghunter || {}; 	
	...
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_default_action[1] = ["180","181","182"];
	Moghunter.v_actor_default_action[2] = ["380","381","382"];
...
//	Moghunter.v_actor_item[4] = {1:["P4_Action_01","P4_Action_02","P4_Action_03"]};	
	...
	// ACTOR - DAMAGE
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_damage[1] = ["183"];
	Moghunter.v_actor_damage[2] = ["383"];
	...
	// ACTOR - DEAD
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_dead[1] = ["184"];
	Moghunter.v_actor_dead[2] = ["384"];
	...
	// -----------------------------------------------------------------------		
	Moghunter.v_enemy_default_action[18] = ["280","281","282"];
...
//	Moghunter.v_enemy_skill[901] = {1:["P2_Action_04","P2_Action_05","P2_Action_06"]};	
	...
	// ENEMY - DAMAGE
	// -----------------------------------------------------------------------		
	Moghunter.v_enemy_damage[18] = ["283"];
	...
	// ENEMY - RECOVER
	// -----------------------------------------------------------------------		
	Moghunter.v_enemy_recover[900] = ["284"];
	Moghunter.v_enemy_recover[901] = ["P2_Recover_01","P2_Recover_02"];
	// -----------------------------------------------------------------------
	// ENEMY - DEAD
	// -----------------------------------------------------------------------		
	Moghunter.v_enemy_dead[18] = ["284"];
