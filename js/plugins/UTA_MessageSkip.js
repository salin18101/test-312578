...
//=============================================================================
/*:
 * @plugindesc Skip message by pressing a particular key.
 * @author T.Akatsuki
 * 
 * @param Skip Key
 ...
 * 
 * @help # Overview
 * MessageSkip plugin can be done to skip in that continue to press a specific key in a message display.
 * Well there is a message skip functions in such Novel games.
 * Skip if choice window will be temporarily suspended.
 * 
 * # Parameters
 *   Skip Key [any key]
