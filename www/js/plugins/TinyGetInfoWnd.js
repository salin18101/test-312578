 ...
 *
 *【REFMAP改変】
 * 266行目：this._baseSprite.addChild(w);を
 *          this._pictureContainer.addChild(w);に変更
 */
...
(function() {
  ...
  var seFilename = parameters['SE filename'] || 'Coin';
...
//    this._baseSprite.addChild(w);
    this._pictureContainer.addChild(w);
  };
  ...
  Window_GetInfo.prototype.setup = function(id, type, text, value) {
    ...
    this.contents.fillRect(0, 21, 1280, 36, '#000000');
